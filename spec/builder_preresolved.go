...
// Reverse ops. candy/plugin-bundle's preresolveBuilderContexts BUILDS it plugin-side (over
...
// spec.BuilderPreresolved` forwarder so its callers + candy/plugin-bundle compile unchanged.
