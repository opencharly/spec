...
// was written. Used to assert the loud-warning behavior of parseHostPorts and
// buildPortMapping — the silent-skip those functions used to perform was the root
// cause of an entire tunnel-emission disappearing without any diagnostic to the
// operator. Relocated from sdk/deploykit/tunnel_resolve_test.go (#55 U5) alongside
// the resolution functions themselves.
