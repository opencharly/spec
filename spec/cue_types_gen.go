...
type DocsConfig struct {
	Sources DocsSources `yaml:"sources,omitempty" json:"sources,omitempty"`

	Marketplace DocsMarketplace `yaml:"marketplace,omitempty" json:"marketplace,omitempty"`

	Projections DocsProjections `yaml:"projections,omitempty" json:"projections,omitempty"`

	Output DocsOutput `yaml:"output,omitempty" json:"output,omitempty"`

	Landing DocsLanding `yaml:"landing,omitempty" json:"landing,omitempty"`

	Gates DocsGates `yaml:"gates,omitempty" json:"gates,omitempty"`
}

// #DocsSources — where the reference documentation is GENERATED from.
type DocsSources struct {
	...
	Compiled DocsCompiled `yaml:"compiled,omitempty" json:"compiled,omitempty"`
	...
	ReleaseRepos []string `yaml:"release_repos,omitempty" json:"release_repos,omitempty"`
...
type DocsCompiled struct {
	...
	CompiledPluginsPath string `yaml:"compiled_plugins_path,omitempty" json:"compiled_plugins_path,omitempty"`

	// go_mod_path — the go.mod require: source for the release_repos resolution.
	GoModPath string `yaml:"go_mod_path,omitempty" json:"go_mod_path,omitempty"`
}

// #DocsMarketplace — the marketplace repo layout (the `marketplace generate` input).
type DocsMarketplace struct {
...
type DocsProjections struct {
	Recipes bool `yaml:"recipes,omitempty" json:"recipes,omitempty"`

	Cli bool `yaml:"cli,omitempty" json:"cli,omitempty"`

	Providers bool `yaml:"providers,omitempty" json:"providers,omitempty"`

	Candy bool `yaml:"candy,omitempty" json:"candy,omitempty"`

	Box bool `yaml:"box,omitempty" json:"box,omitempty"`

	Plugin bool `yaml:"plugin,omitempty" json:"plugin,omitempty"`

	Landing bool `yaml:"landing,omitempty" json:"landing,omitempty"`
}
...
type DocsOutput struct {
	...
	HandAuthored []string `yaml:"hand_authored,omitempty" json:"hand_authored,omitempty"`
}
...
type DocsGates struct {
	// site_links — every generated page link resolves in the built site.
	SiteLinks bool `yaml:"site_links,omitempty" json:"site_links,omitempty"`

	// sidebar_links — every sidebar entry resolves on its page.
	SidebarLinks bool `yaml:"sidebar_links,omitempty" json:"sidebar_links,omitempty"`
...
type PodConfigSaveDeployReply struct {
}
